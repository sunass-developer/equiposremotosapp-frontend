...
import { IndicadorService } from './../../../_service/indicador.service';
import { Chart } from 'chart.js';

@Component({
  selector: 'app-estacion-grafico',
  templateUrl: './estacion-grafico.component.html',
  styleUrls: ['./estacion-grafico.component.css']
})
export class EstacionGraficoComponent implements OnInit {
